...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#e1ebe0] relative overflow-hidden pb-24">
      {/* Background Elements */}
      ...
      <header className="relative z-10 px-4 py-4">
        <div className="mx-auto max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            />
            <p className="text-xl text-foreground font-bebas tracking-wide mb-4">discover the city</p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-12 border border-primary/20 text-center">
            ...
            <div className="mt-8">
              <Button
                ...
                className="bg-primary text-white hover:bg-primary/90 font-medium px-8 py-6 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all"
              >
