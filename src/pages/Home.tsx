        ...
        <div className="mx-auto max-w-md">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-12 border border-blue-100/50 text-center">
            <h2 className="text-3xl md:text-4xl font-bebas font-normal text-blue-900 leading-tight tracking-wide">
              We've gathered the best of Como — <span className="text-orange-700">explore</span> the map, <span className="text-orange-700">discover</span> the blog, <span className="text-orange-700">follow</span> your path, and <span className="text-orange-700">become</span> your own guide. Because we're just True Local.
            </h2>
