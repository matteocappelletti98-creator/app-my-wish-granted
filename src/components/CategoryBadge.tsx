...
export default function CategoryBadge({ category, showLabel=false }:{
  ...
  const labelMap: Record<CategoryKey,string> = {
    ...
    luxury:"Private & Luxury", transport:"Public Transport", villa:"Villa", stroll:"Strolls", lidi:"Beach Resorts",
    secret:"Secret Places", gelato:"Gelato", daytrips:"Day Trips", bakery:"Bakery", shopping_hq:"Luxury Shopping", 
    wc:"Public Toilets", adventure:"Adventure", refuge:"Mountain Refuge", grocery:"Grocery", 
    nightlife:"Night Life", streetfood:"Street Food", luggage:"Luggage Storage", atm:"ATM", other:"Other"
  };
  return (
